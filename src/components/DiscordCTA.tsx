      ...
      <div className="relative z-10 container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <div className="flex justify-center mb-6 animate-fade-in">
            <div className="bg-white/10 backdrop-blur-sm p-4 rounded-2xl animate-float">
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-6 font-poppins animate-fade-in" style={{ animationDelay: '0.1s' }}>
            UNISCITI AL NOSTRO DISCORD
          </h2>

          <p className="text-lg md:text-xl mb-8 font-poppins text-white/90 max-w-2xl mx-auto animate-fade-in" style={{ animationDelay: '0.2s' }}>Entra all'interno del nostro Server Discord! Chatta con altri giocatori, crea nuove amicizie, partecipa agli eventi e ricevi supporto dal nostro Staff!</p>

          <Button asChild size="lg" className="bg-white/20 hover:bg-white/30 backdrop-blur-sm text-white border-2 border-white/30 font-poppins font-bold text-lg px-8 py-6 transition-all duration-300 hover:scale-110 hover:shadow-glow animate-fade-in" style={{ animationDelay: '0.3s' }}>
